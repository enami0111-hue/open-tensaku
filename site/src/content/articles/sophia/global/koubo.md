...
heroImage: /thumbnails/sophia/global/koubo.png
keywords:
  - "上智 総合グローバル学部 志望理由"
  - "上智 グローバル 公募推薦 志望理由"
  - "上智 総合グローバル 志望理由書"
...
「上智総合グローバル学部の公募推薦、FLAや外国語学部と何が違うの？」「グローバルという名前だけど、具体的に何を学ぶの？」——上智大学総合グローバル学部（2014年設立）の公募制推薦入試では、**「グローバルに関心があります」という表明ではなく「特定の地域課題やグローバル問題を学際的に分析したい」という問いの具体性**が評価を左右しやすくなります。
...
<h2 id="ap">総合グローバル学部のAPと学部の特徴</h2>
...
<h2 id="three-faculty">FLA・外国語学部との3学部差別化</h2>
...
**評価されやすいポイント**：面接では「なぜFLAではなく総合グローバルか」という問いへの明確な答えが必須です。また「どの地域を研究フィールドにしたいか」「そのフィールドで何を研究するか」が深掘りされます。
