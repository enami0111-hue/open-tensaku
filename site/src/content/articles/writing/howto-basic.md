...
**結論から言えば、志望理由書の評価を左右しやすい要素は「熱意の量」ではなく「構造の正確さ」です。** 志望理由書や面接で見られやすい観点をふまえると、採用側・大学側の読み手が求めているのは「感動する文章」ではなく「論理的に整理された、この受験生にしか書けない理由」です。
...
最低3回の推敲が必要です。第1稿→構成の確認→第2稿→内容の深掘り→第3稿→添削後の修正→完成稿、という流れが標準です。「最初に書いたものをそのまま提出する」受験生は毎年います——それは「最低限の準備しかしていない」という準備不足と受け取られかねないサインです。

---

## まとめ：志望理由書で評価を左右しやすい3つのポイント
...
- [志望理由書の5つのNG｜評価されにくい志望理由の共通パターン](/articles/writing/ng-patterns/)
