...
推薦書・調査書・提出書類の扱いは大学・高校により異なるため、最新の実施要項と各大学の募集要項を必ず確認してください。
...
多くの場合「開封無効」で、先生が直接封をした状態で提出します。内容を受験生が確認することは通常できません。事前にどんな内容を書いてもらえるか不安な場合は、依頼メモで「書いてほしいポイント」を伝えることが有効な対策です。

### Q3. 複数の大学に同時出願する場合、同じ先生に複数の推薦書を頼んでいい？

可能です。ただし先生の負担を考え、「○校分お願いします」と最初からまとめて依頼するほうが先生に親切です。出願校が多い場合は、特に重要な2〜3校に絞ることも検討してください。
